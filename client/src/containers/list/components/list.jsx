...
export default class CList extends React.Component {
    render() {
        return <Wrapper>
            <Button secondary onClick={this.props.onLogoutClick}>Log out</Button>
            <List>
                <List.Item>
                ...
                <List.Item>
                    ...
                    <List.Content>
                        ...
                        <List.Description>Last seen watching <a><b>Bob's Burgers</b></a> 10 hours
                            ago.</List.Description>
                    </List.Content>
                </List.Item>
                <List.Item>
                    ...
                    <List.Content>
                        ...
                        <List.Description>Last seen watching <a><b>The Godfather Part 2</b></a>
                            yesterday.</List.Description>
                    </List.Content>
                </List.Item>
                <List.Item>
                    <Image avatar src='https://react.semantic-ui.com/assets/images/avatar/small/jenny.jpg'/>
                    <List.Content>
